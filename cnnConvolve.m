function convolvedFeatures = cnnConvolve(filterDim, numFilters, images, W, b,validity)
...
for imageNum = 1:numImages
  for filterNum = 1:numFilters
    ...
    result_1 = conv2(im,filter,str);
    
    % Add the bias unit
    % Then, apply the sigmoid function to get the hidden activation

    result_1 = result_1 + b(filterNum,:);
    convolvedImage = 1.0 ./ (1.0 + exp(-result_1));
